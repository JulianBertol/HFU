/*
 ============================================================================
 Name        : A14_EmployeeWithoutMutex.c
 Author      : EC
 Version     :
 Copyright   :
 Description : multithread without safe mutex handling
 see: http://www.cs.kent.edu/~ruttan/sysprog/lectures/multi-thread
...
main(int argc, char* argv[])
{
	...
	printf("Perfect, employees contents was always consistent\n");
